                          ...
                          <div class="card-content collapse show">
                            ...
                            <span style="display: flex">
                              ...
                              <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Completed" v-model="form.essential[essn.id]" :name="'status_completed'+essn.id">
                                  <b>Completed</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="In Progress"  v-model="form.essential[essn.id]" :name="'status_in_progress'+essn.id">
                                    <b>In Progress</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Not Started" v-model="form.essential[essn.id]" :name="'status_not_started'+essn.id">
                                   <b>Not Started</b>
                                </label>
                            </fieldset>
                              </div>
                                <div style="margin-left: 15%;">
                                   <textarea  cols="30" rows="2" class="form-control" v-model="form.essential_comment[essn.id]" placeholder="Your comment here"></textarea>
                                </div>
                  ...
                  <div class="col-md-6" v-for="cus in customers" style="margin-top: -10px">
                      <div class="card">
                          ...
                          <span style="display: flex">
                            ...
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Completed" v-model="form.customer[cus.id]" :name="'status_completed_1'+cus.id">
                                    <b>Completed</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="In Progress" v-model="form.customer[cus.id]" :name="'status_in_progress_1'+cus.id">
                                    <b>In Progress</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Not Started" v-model="form.customer[cus.id]" :name="'status_not_started_1'+cus.id">
                                    <b>Not Started</b>
                                </label>
                            </fieldset>
                                </div>
                                 <div style="margin-left: 15%;">
                                   <textarea cols="30" rows="2" class="form-control" v-model="form.customer_comment[cus.id]"  placeholder="Your comment here"></textarea>
                                </div>
                            </span>
                              </div>
                          </div>
                  ...
                  <div class="col-md-6" v-for="stf in staff" style="margin-top: -10px">
                      <div class="card">
                          ...
                          <div class="card-content collapse show">
                            ...
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Completed" v-model="form.staff[stf.id]" :name="'status_completed'+stf.id">
                                    <b>Completed</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="In Progress" v-model="form.staff[stf.id]" :name="'status_in_progress'+stf.id">
                                    <b>In Progress</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Not Started" v-model="form.staff[stf.id]" :name="'status_not_started'+stf.id">
                                    <b>Not Started</b>
                                </label>
                            </fieldset>
                                </div>
                                  <div style="margin-left: 15%;">
                                   <textarea cols="30" rows="2" class="form-control" v-model="form.staff_comment[stf.id]" placeholder="Your comment here"></textarea>
                                </div>
                            </span>
                              </div>
                          </div>
                  ...
                  <div class="col-md-6" v-for="comm in communication" style="margin-top: -10px">
                      <div class="card">
                          ...
                          <div class="card-content collapse show">
                            ...
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Completed" v-model="form.communication[comm.id]" :name="'status_completed'+comm.id">
                                    <b>Completed</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="In Progress" v-model="form.communication[comm.id]" :name="'status_in_progress'+comm.id">
                                    <b>In Progress</b>
                                </label>
                            </fieldset>
                            <fieldset class="radio">
                                <label>
                                    <input type="radio"  value="Not Started" v-model="form.communication[comm.id]" :name="'status_not_started'+comm.id">
                                    <b>Not Started</b>
                                </label>
                            </fieldset>
                             </div>
                                 <div style="margin-left: 15%;">
                                 <textarea cols="30" rows="2" class="form-control" v-model="form.communication_comment[comm.id]" placeholder="Your comment here"></textarea>
                               </div>
                            </span>
                              </div>
                          </div>
...
export default {
    ...
    methods:{
        postData(){
            ...
            let data = {essential:this.essential_data,customer:this.customer_data,staff:this.staff_data,communication:this.communication_data,month:this.month,year:this.year};
