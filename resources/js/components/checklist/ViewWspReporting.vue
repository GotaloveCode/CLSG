            ...
            <form>
                <div class="row">
                        ...
                        <fieldset class="the-fieldset">
                            ...
                            <table style="width: 100%">
                                ...
                                <tr v-for="(item,k) in form.status_of_covid_implementation" :key="k">
                                    <td>
                                        <input type="text" class="form-control" v-model="item.item_name" placeholder="name" style="margin-top: 5px" disabled>
                                    </td>
                                    <td><input type="text" class="form-control ml-10" v-model="item.description" placeholder="description" style="margin-top: 5px;" disabled>
                                    </td>
                    ...
                    <div class="col-md-4 form-group">
                        ...
                        <vue-numeric separator="," v-model="form.revenue" class="form-control" required disabled></vue-numeric>
                    </div>
                    <div class="col-md-4 form-group">
                        <label>O&M costs this month (KES)</label>
                        <vue-numeric separator="," v-model="form.operations_costs" class="form-control" required disabled></vue-numeric>
                    </div>

                    <div class="col-md-4 form-group">
                        <label>Total CLSG amount disbursed to date (KES)</label>
                        <vue-numeric separator="," v-model="form.clsg_total" class="form-control" required disabled></vue-numeric>
                    </div>
                    <div class="col-md-6">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="status_of_resolution" id="yes" value="1" v-model="form.status_of_resolution" disabled>
                                <label class="custom-control-label" for="yes">Yes</label>
                            </div>
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="status_of_resolution" id="no"  value="0" v-model="form.status_of_resolution" disabled>
                                <label class="custom-control-label" for="no">No</label>
                            </div>

                            <div class="form-group" v-if="form.status_of_resolution ==1" style="margin-top: 4%">
                                <label>Comment</label>
                                <textarea class="form-control" required v-model="form.status_of_resolution_comment" disabled></textarea>
                            </div>
                        </fieldset>
                    </div>
                    ...
                    <div class="col-md-6 form-group">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="challenges" id="yes_1" value="1" v-model="form.challenges" disabled>
                                <label class="custom-control-label" for="yes_1">Yes</label>
                            </div>
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="challenges" id="no_1"  value="0" v-model="form.challenges" disabled>
                            ...
                            <div class="form-group" v-if="form.challenges ==1" style="margin-top: 4%">
                                ...
                                <textarea class="form-control" required v-model="form.challenges_cooment" disabled></textarea>
                            </div>
                        </fieldset>
                    </div>
                                ...
                                <tr v-for="(item,k) in form.expected_activities" :key="k">
                                    <td>
                                        <v-select label="name" placeholder="Select Activity"
                                                  v-model="item.activity" :reduce="s => s.id" :options="services" disabled>
                                        </v-select>
                                    </td>
                                    <td><input type="text" class="form-control ml-10" v-model="item.description" placeholder="description" style="margin-top: 5px;" disabled>
                                    </td>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group">
                                ...
                                <textarea  class="form-control" v-model="form.bcp_evidence" disabled></textarea>
                    ...
                    <div class="col-md-6">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group" style="margin-left: 1.5%">
                                <label>List of evidence provided</label>
                                <textarea  class="form-control" v-model="form.erp_evidence" disabled></textarea>
                            </div>
                        </fieldset>
                    </div>
                    <div class="col-md-6">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group" style="margin-left: 1.5%">
                                <label>List of evidence provided</label>
                                <textarea  class="form-control" v-model="form.bcp_erp_evidence" disabled></textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group" style="margin-left: 1.5%">
                                <label>List of evidence provided</label>
                                <textarea  class="form-control" v-model="form.financial_evidence" disabled></textarea>
                            </div>
                        </fieldset>
                    </div>
                    <div class="col-md-6">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group">
                                <label>List of evidence provided</label>
                                <textarea  class="form-control" v-model="form.performance_evidence" disabled></textarea>
                            </div>
                        </fieldset>
                    </div>
                    <div class="col-md-6">
                        ...
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group">
                                <label>List of evidence provided</label>
                                <textarea  class="form-control" v-model="form.compliance_evidence" disabled></textarea>
                            </div>
                        </fieldset>
                    </div>
                    ...
                    <div class="col-md-6">
                        <fieldset class="the-fieldset">
                            ...
                            <div class="form-group" v-if="form.collection_efficiency ==1" style="margin-top: 4%">
                                <label>Comment</label>
                                <textarea class="form-control" v-model="form.collection_efficiency_comment" disabled></textarea>
                            </div>
                            <div class="form-group">
                                <label>Achievement(brief self-assessment)</label>
                    ...
                    <div class="col-md-6">
                        ...
                        <fieldset class="the-fieldset">
                            ...
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="nrw" id="yes_n" value="1" v-model="form.nrw" disabled>
                                <label class="custom-control-label" for="yes_n">Yes</label>
                            </div>
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="nrw" id="no_n"  value="0" v-model="form.nrw" disabled>
                            ...
                            <div class="form-group" v-if="form.nrw ==0" style="margin-top: 4%">
                                ...
                                <textarea class="form-control" v-model="form.nrw_comment" disabled></textarea>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <fieldset class="the-fieldset">
                            ...
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="service_per_day" id="yes_c" value="1" v-model="form.service_per_day" disabled>
                                <label class="custom-control-label" for="yes_c">Yes</label>
                            </div>
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="service_per_day" id="no_c"  value="0" v-model="form.service_per_day" disabled>
                                <label class="custom-control-label" for="no_c">No</label>
                            </div>

                            <div class="form-group" v-if="form.service_per_day ==1" style="margin-top: 4%">
                                <label>Comment</label>
                                <textarea class="form-control" v-model="form.service_per_day_comment" disabled></textarea>
                            </div>
                            <div class="form-group" style="margin-top: 2%">
                                <label>Achievement(brief self-assessment)</label>
                                <input type="text" class="form-control" v-model="form.nrw_score" disabled>
                    ...
                    <div class="col-md-6">
                        <fieldset class="the-fieldset"><legend class="the-legend"><label class="fyr">Maintain drinking water quality within acceptable range</label></legend>
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="drinking_water" id="yes_d" value="1" v-model="form.drinking_water" disabled>
                                <label class="custom-control-label" for="yes_d">Yes</label>
                            </div>
                            <div class="d-inline-block custom-control custom-radio mr-1">
                                <input type="radio" class="custom-control-input" name="drinking_water" id="no_d"  value="0" v-model="form.drinking_water" disabled>
                                <label class="custom-control-label" for="no_d">No</label>
                            </div>

                            <div class="form-group" v-if="form.drinking_water ==1" style="margin-top: 4%">
                                <label>Comment</label>
                                <textarea class="form-control" v-model="form.drinking_water_comment" disabled></textarea>
                            </div>
                            <div class="form-group" style="margin-top: 2%">
                                <label>Achievement(brief self-assessment)</label>
...
export default {
    ...
    created() {
        console.log('walla')
        console.log(this.wsp_report);
       this.setUp();
    },

    methods: {
        setUp(){
         this.form = this.wsp_report;
        },
        goBack(){
