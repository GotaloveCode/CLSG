                ...
                <div class="row">
                    <div class="col-md-6">
                             ...
                             <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" v-model="form.verification_period" required  style="margin-left: 10px;width: 94%">
                              </div>
                              </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Verification team</label>
                            <input type="text" class="form-control" v-model="form.verification_team" required  style="width: 94%">
                        </div>
                        <div class="form-group">
                            <label>Recommendations</label>
                            <textarea  cols="20" rows="2" class="form-control" v-model="form.recommendations" placeholder="recommendations" style="width: 94%"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6" v-for="score in scores" style="margin-top: -10px">
                        <div class="card">
                            <div class="card-header">
                                <p><i class="fa fa-angle-double-right" aria-hidden="true"></i><b>Indicator:</b> {{score.name}}</p>
                            </div>
                          ...
                          <span style="display: flex">
                            ...
                            <div class="form-group">
                                ...
                                <span style="display: flex">
                                   <div>
                                     <input type="number" class="form-control" v-model="form.score_value[score.id]">
                                   </div>
                                   <div>
                                     <p>out of</p>
                                   </div>
                                   <div>
                                     <input type="number" class="form-control" v-model="form.score_out_of[score.id]">
                                   </div>
                                </span>
                            </div>
                                </div>
                                 <div style="margin-left: 4%;">
                                   <div class="form-group" style="margin-top: 10px">
                                       ...
                                       <textarea cols="30" rows="2" class="form-control" v-model="form.score_comment[score.id]"  placeholder="Your comment here"></textarea>
                                   </div>
                                </div>
                            </span>
                                </div>
                    ...
                    <div class="col-md-6" v-for="dt in determinations" style="margin-top: -10px">
                        <div class="card">
                            ...
                            <div class="form-group" style="margin-top: 7%">
                                <input type="number" class="form-control" step="0.001" v-model="form.amount[dt.id]" placeholder="Amount">
                            </div>
                                </div>
                                  <div style="margin-left: 5%;">
                                   <textarea cols="30" rows="2" class="form-control" v-model="form.determination_comment[dt.id]" placeholder="Your comment here"></textarea>
                                </div>
                            </span>
                                </div>
                            </div>
