<template>
 <form>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="details.bcp_status_implementation" required  style="margin-left: 10px;width: 94%" disabled>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="details.covid_status_implementation" required  style="margin-left: 10px;width: 94%" disabled>
                            </div>
                            <div class="form-group">
                                <label style="margin-left: 10px">Revenues collected this month (KES)</label>
                                <vue-numeric separator="," v-model="details.revenues_collected" class="form-control" required style="margin-left: 10px;width: 94%" disabled></vue-numeric>

                            </div>
                            <div class="form-group">
                                <label  style="margin-left: 10px">O&M costs this month (KES)</label>
                                <vue-numeric separator="," v-model="details.o_m_costs" class="form-control" required style="margin-left: 10px;width: 94%" disabled></vue-numeric>

                            </div>
                            <div class="form-group">
                                <label style="margin-left: 10px">Total CLSG amount disbursed to date (KES)</label>
                                <vue-numeric separator="," v-model="details.amount_disbursed" class="form-control" required style="margin-left: 10px;width: 94%" disabled></vue-numeric>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" v-model="details.resolution_status" required  style="width: 94%" disabled>
                            </div>
                            <div class="form-group">
                                <label>Challenges (if any) encountered during the reporting period and mitigation measures</label>
                                <textarea  class="form-control" required v-model="details.challenges" placeholder="Challenges" style="width: 94%" disabled></textarea>
                            </div>
                            <div class="form-group">
                                <label>Expected activities for the next month (specifying any planned procurement or contracting)</label>
                                <textarea  class="form-control" v-model="details.expected_activities_next_month" style="    width: 94%" required disabled></textarea>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6" v-for="score in details.score_details" style="margin-top: -10px">
                        <div class="card">
