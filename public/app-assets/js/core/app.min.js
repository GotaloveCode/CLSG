!function (e, n, a) {
    ...
    if (a(e).on("load", (function () {
        var e = !1;
        s.hasClass("menu-collapsed") && (e = !0), a("html").data("textdirection"), setTimeout((function () {
            t.removeClass("loading").addClass("loaded")
        }), 1200), a.app.menu.init(e);
        !1 === a.app.nav.initialized && a.app.nav.init({speed: 300}), Unison.on("change", (function (e) {
            ...
            e.preventDefault(), a(this).closest(".card").children(".card-content").collapse("toggle"), a(this).closest(".card").find('[data-action="collapse"] i').toggleClass("icon-plus icon-minus")
        })), a('a[data-action="expand"]').on("click", (function (e) {
            e.preventDefault(), a(this).closest(".card").find('[data-action="expand"] i').toggleClass("icon-maximize icon-minimize"), a(this).closest(".card").toggleClass("card-fullscreen")
        ...
        var i = s.data("menu");
        "horizontal-menu" != i && !1 === e && a(".main-menu-content").find("li.active").parents("li").addClass("open"), "horizontal-menu" == i && (a(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), a(".main-menu-content").find("li.active").parents("li").addClass("active")), !0 === e && a(".main-menu-content").find("li.active").parents("li").addClass("menu-collapsed-open"), a(".heading-elements-toggle").on("click", (function () {
            a(this).parent().children(".heading-elements").toggleClass("visible")
        }));
        var o = a(".chartjs"), l = o.children("canvas").attr("height");
        if (o.css("height", l), s.hasClass("boxed-layout") && s.hasClass("vertical-overlay-menu")) {
            var r = a(".main-menu").width(), c = a(".app-content").position().left - r;
            s.hasClass("menu-flipped") ? a(".main-menu").css("right", c + "px") : a(".main-menu").css("left", c + "px")
        }
        var d = a(".search-input input").data("search");
        a(".nav-link-search").on("click", (function () {
            a(this);
            a(this).parent(".nav-search").find(".search-input").addClass("open"), a(".search-input input").focus(), a(".search-input .search-list li").remove(), a(".search-input .search-list").addClass("show")
            ...
            if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
                ...
                if (a("ul.search-list li").remove(), "" != n) {
                    ...
                    var t = "", s = "", i = "", o = 0;
                    a.getJSON("../../../app-assets/data/" + d + ".json", (function (e) {
        ...
        if (a(i).length > 0) new Hammer(i).on("panright", (function (e) {
        ...
        if (a(o).length > 0) new Hammer(o).on("panleft", (function (e) {
            if (s.hasClass("vertical-overlay-menu")) return a.app.menu.hide(), !1
        }))
    }
    a(n).on("click", ".menu-toggle, .modern-nav-toggle", (function (n) {
        ...
        screenfull.isFullscreen ? a(".nav-link-expand").find("i").toggleClass("icon-minimize icon-maximize") : a(".nav-link-expand").find("i").toggleClass("icon-maximize icon-minimize")
    ...
    let l = .01 * e.innerHeight;
    n.documentElement.style.setProperty("--vh", `${l}px`), e.addEventListener("resize", () => {
        let a = .01 * e.innerHeight;
