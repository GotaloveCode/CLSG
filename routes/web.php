...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('eoi/{eoi}/attachments', [EoiAttachmentController::class,'index'])->name('eoi.attachments');
    Route::post('eoi/{eoi}/attachments',[EoiAttachmentController::class,'store'])->name('eoi.attachments.store');
