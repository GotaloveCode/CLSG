...
Route::apiResource('contractors', '\App\Http\Controllers\API\ContractorAPIController');

Route::apiResource('essentialsupplies', '\App\Http\Controllers\API\EssentialsupplyAPIController');
