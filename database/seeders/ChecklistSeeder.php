...
class ChecklistSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        BcpChecklist::create(['name' => 'Determine the potential impact of the pandemic on utility-related travel (e.g. quarantines, border closures that limit availability of chemicals), including suppliers who make deliveries. Encourage suppliers to develop their own pandemic BCPs', 'type' => 'Essential Operations']);BcpChecklist::create(['name' => 'Evaluate impact of pandemic on billing and revenue collection and develop plans to ensure the utility maintains an acceptable level of revenue collections', 'type' => 'Essential Operations']);
